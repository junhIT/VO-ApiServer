...
@Entity
@Table(name = "COMMENT_ATCH_TB")
@NoArgsConstructor
@AllArgsConstructor
@Getter
@Setter
@Builder
public class CommentAtchEntity {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private int commentAtchNo;	// 댓글첨부내역번호
	
	@ManyToOne(fetch = FetchType.EAGER)
	@JoinColumn(name = "commentNo")		// 회원번호(글작성자)
	private CommentEntity comment;	// 회원테이블
